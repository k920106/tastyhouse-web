import ReviewProductDetailPageSkeleton from './_components/ReviewProductDetailPageSkeleton'

export default function ProductReviewPageLoading() {
  return <ReviewProductDetailPageSkeleton />
  // <>
