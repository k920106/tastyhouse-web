      ...
      <div className="pt-14 pb-20">
        ...
        <div className="px-6 mb-16">
          <button
            ...
            className="w-full bg-[#333333] text-white text-[16px] font-medium py-4 rounded-lg active:bg-[#222222] transition-colors"
          >
            전화 문의
          </button>
        </div>
        ...
        <div className="px-6 mb-6">
          <h3 className="text-[16px] font-medium text-gray-900 mb-4">고객센터 이용 안내</h3>
        ...
        <div className="px-6">
          <button
            ...
            className="w-full bg-[#FEE500] text-gray-900 text-[16px] font-medium py-4 rounded-lg active:bg-[#F5DC00] transition-colors flex items-center justify-center gap-2"
          >
