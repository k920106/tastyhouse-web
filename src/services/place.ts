...
export async function getPlaceReviews(placeId: number, params?: GetPlaceReviewsParams) {
  ...
  return api.get<ApiResponse<PlaceReviewsByRatingResponse>>(API_ENDPOINTS.PLACES_REVIEWS(placeId), {
    params: queryParams,
  })
}
